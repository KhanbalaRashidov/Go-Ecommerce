...
func WithJWTAuth(handlerFunc http.HandlerFunc, store repo.UserStore) http.HandlerFunc {
...
func permissionDenied(w http.ResponseWriter) {
	helper.WriteError(w, http.StatusForbidden, fmt.Errorf("permission denied"))
}
